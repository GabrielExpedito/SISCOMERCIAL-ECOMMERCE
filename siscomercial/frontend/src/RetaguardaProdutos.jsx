      ...
      <form onSubmit={salvar}>
        <div className="produto-editor-grid">
          ...
          <div className="produto-editor-campo">
            ...
            <input value={form.categoria || ""} onChange={(e) => editar("categoria", e.target.value)} placeholder="Ex.: MLB123456" />
            <small>Por enquanto informe o ID da categoria. A pesquisa de categorias será adicionada depois.</small>
          </div>
          <div className="produto-editor-campo">
            <label>Status</label>
          ...
          {filtrados.map((produto) => (
            <article className="linha-produto-retaguarda" key={produto.id}>
              ...
              <div className="linha-produto-info">
                ...
                <span>{produto.categoria || "Categoria não informada"}</span>
              </div>
              <div>
